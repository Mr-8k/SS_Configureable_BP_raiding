...
public class BlueprintGroundRaidObjectivePluginImplMOD extends BaseGroundRaidObjectivePluginImpl {

    public static float PROBABILITY_TO_DROP_BP_NOT_DROPPED_BEFORE = 2f;

    protected int bpUseScale = 0;
    public BlueprintGroundRaidObjectivePluginImplMOD(MarketAPI market) {
